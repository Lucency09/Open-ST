...
Open-ST 是一款 Windows 截图与标注工具，同时提供安装版和便携版。OCR 与翻译仍在规划中。

当前版本为 **0.3.0**，目标平台为 Windows 10 22H2／Windows 11 x64；实际验收范围与限制见[发行说明](releases/v0.3.0.md)。

## 下载与使用

从 [v0.3.0 Releases](https://github.com/Lucency09/Open-ST/releases/tag/v0.3.0) 下载：
...
本版新增顶层窗口预选、完整标注、原位文字、局部橡皮擦、多档马赛克、撤销／重做、可配置快捷键、安装发布和关于窗口更新，并修复已反馈的跨屏拖动掉帧问题。
